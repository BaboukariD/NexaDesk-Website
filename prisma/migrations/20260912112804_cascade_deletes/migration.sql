...
CREATE TABLE "new_Flashcard" (
    ...
    CONSTRAINT "Flashcard_vocabId_fkey" FOREIGN KEY ("vocabId") REFERENCES "VocabItem" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
...
CREATE TABLE "new_ReviewState" (
    ...
    CONSTRAINT "ReviewState_flashcardId_fkey" FOREIGN KEY ("flashcardId") REFERENCES "Flashcard" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_ReviewState" ("difficulty", "due", "flashcardId", "id", "lapses", "lastReview", "learningSteps", "reps", "scheduledDays", "stability", "state", "userId") SELECT "difficulty", "due", "flashcardId", "id", "lapses", "lastReview", "learningSteps", "reps", "scheduledDays", "stability", "state", "userId" FROM "ReviewState";
