(async function () {
  ...
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
  ...
  .nd-btn{
    ...
    z-index:2147483647;
    box-shadow:0 10px 32px rgba(59,130,246,.42);
  ...
  .nd-footer a{color:#3B82F6;text-decoration:none;font-weight:600;}
  ...
  .nd-msg.bot a{color:#2563EB;font-weight:600;text-decoration:underline;}
